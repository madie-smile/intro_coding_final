...
function animationLoop() {
    ...
    //     torus(allSquares[l]);
    //     //bomb & worm collision function within foor loop iterating over array of square bombs
    //     collision_bomb(allCircles[i], allSquares[l]);
...
function rectBomb(b){
    ...
    ctx.fill();
    // ctx.lineWidth=b.lw;
    // ctx.strokeStyle = "hsla(" + b.c + ", 100%, 50%, " + b.a + ")";
    // ctx.stroke(); 
    b.x = x;
    b.y = y;
}
